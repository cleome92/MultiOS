...
{
	setAppNum(NUM_APP0);
	SetTransTable_MultiOS(0x00000000, 0x0CDFFFFF, 0x00000000, RW_NO_ACCESS);
	SetTransTable_MultiOS(0x0CE00000, 0x13FFFFFF, 0x0CE00000, RW_NCNB);
	SetTransTable_MultiOS(0x14000000, DRAM_START_ADDR-1, 0x14000000, RW_NO_ACCESS);
	SetTransTable_MultiOS(DRAM_START_ADDR, MMU_PAGE_TABLE_BASE-1, DRAM_START_ADDR, RW_WBWA);
	SetTransTable_MultiOS(MMU_PAGE_TABLE_BASE, MMU_PAGE_TABLE_LIMIT-1, MMU_PAGE_TABLE_BASE, RW_WBWA);

	/* Free Memory */
	SetTransTable_MultiOS(MMU_PAGE_TABLE_LIMIT, LCD_FB00_START_ADDR-1, MMU_PAGE_TABLE_LIMIT, RW_NCNB);

	/* LCD Frame Buffer */
	SetTransTable_MultiOS(LCD_FB00_START_ADDR, LCD_FB01_START_ADDR-1, LCD_FB00_START_ADDR, RW_WT);
	SetTransTable_MultiOS(LCD_FB01_START_ADDR, LCD_FB10_START_ADDR-1, LCD_FB01_START_ADDR, RW_WT);
	SetTransTable_MultiOS(LCD_FB10_START_ADDR, LCD_FB11_START_ADDR-1, LCD_FB10_START_ADDR, RW_WT);
	SetTransTable_MultiOS(LCD_FB11_START_ADDR, LCD_FB20_START_ADDR-1, LCD_FB11_START_ADDR, RW_WT);
	SetTransTable_MultiOS(LCD_FB20_START_ADDR, LCD_FB21_START_ADDR-1, LCD_FB20_START_ADDR, RW_WT);
	SetTransTable_MultiOS(LCD_FB21_START_ADDR, LCD_FB30_START_ADDR-1, LCD_FB21_START_ADDR, RW_WT);
	SetTransTable_MultiOS(LCD_FB30_START_ADDR, LCD_FB31_START_ADDR-1, LCD_FB30_START_ADDR, RW_WT);
	SetTransTable_MultiOS(LCD_FB31_START_ADDR, LCD_FB40_START_ADDR-1, LCD_FB31_START_ADDR, RW_WT);
	SetTransTable_MultiOS(LCD_FB40_START_ADDR, LCD_FB41_START_ADDR-1, LCD_FB40_START_ADDR, RW_WT);
	SetTransTable_MultiOS(LCD_FB41_START_ADDR, LCD_FB_END_ADDR-1,     LCD_FB41_START_ADDR, RW_WT);

	SetTransTable_MultiOS(LCD_FB_END_ADDR, 0x80000000-1, LCD_FB_END_ADDR, RW_NO_ACCESS);
	SetTransTable_MultiOS(0x80000000, 0xFFFFFFFF, 0x80000000, RW_NO_ACCESS);
